...
const AddProduct = () => {
    ...
    const [productDetails,setProductCetails] = useState({
        name:"",
    ...
    const changeHandler =(e)=>{
        setProductCetails({...productDetails,[e.target.name]:e.target.value})
    }
    ...
    <div className='addproduct'>
        ...
        <div className="addproduct-itemfield">
            ...
            <select value={productDetails.category} onChange={changeHandler} name="category" className='add-product-selector'>
                <option value="women">Manga</option>
                <option value="men">Figure</option>
                <option value="kid">Apparel</option>
            </select>
        </div>
        <div className="addproduct-itemfield">
